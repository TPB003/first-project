	...
	<body>
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="zulinleixing" id="zulinleixing" lay-filter="zulinleixing"  >
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zulinbeizhu" type="text" :readonly="ro.zulinbeizhu" name="zulinbeizhu" id="zulinbeizhu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.loudongdanyuan" type="text" :readonly="ro.loudongdanyuan" name="loudongdanyuan" id="loudongdanyuan" autocomplete="off" class="layui-input">
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(zulinleixing)', function (data) {
                    vue.detail.zulinleixing=data.value;
                });
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					for(var key in data){
                        ...
                        if(key=='loudongdanyuan'){
                                vue.detail['loudongdanyuan'] = data[`${key}`]
                                vue.ro.loudongdanyuan = true;
                                continue;
                        }
					}
				});
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('cheweizulin/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('cheweizulin' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
