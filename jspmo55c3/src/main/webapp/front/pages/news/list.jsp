...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px auto","borderColor":"rgba(204, 204, 204, 1)","backgroundColor":"#fff","color":"rgba(255, 192, 1, 1)","borderRadius":"0","alignItems":"center","borderWidth":"2px 0","fontSize":"30px","borderStyle":"solid"}'>
			  <span>NEWS / INFORMATION</span><span>通知公告</span>
			</div>
			<!-- 标题 -->
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255, 255, 255, 0.3)","borderStyle":"solid"}'>
					...
					<div class="list news">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="2=='1'?'list-item1':2=='3'?'list-item3':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								...
								<div class="item-info">
									<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"#666","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"20px"}' class="name">{{item.title}}</div>
