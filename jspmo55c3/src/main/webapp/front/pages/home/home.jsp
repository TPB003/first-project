...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 新闻资讯 -->
				<div class="news index-pv2" style="display: flex;justify-content: center;width:100%" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255, 255, 255, 0.3)","borderStyle":"solid"}'>
				  <div class="box" style='width:80%'>
				    ...
				    <div class="title" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px 0 10px 0","borderColor":"rgba(204, 204, 204, 1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(255, 192, 1, 1)","borderRadius":"0","alignItems":"center","borderWidth":"2px 0","fontSize":"30px","borderStyle":"solid"}'>
					...
					<div v-if="newsList.length" class="new-list-6" style="display: flex;">
					  <div class="swiper-container" id="new-list-6news" class="swiper-new-list-6" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0","borderColor":"rgba(255, 192, 1, 1)","backgroundColor":"rgba(255, 192, 1, 1)","borderRadius":"0","borderWidth":"0","width":"60%","borderStyle":"solid","height":"250px"}'>
					  	<div class="swiper-wrapper">
					  		<div class="swiper-slide animation-box" v-for="(item,index) in newsList" v-if="index<5" :key="index" @click="jump('../news/detail.jsp?id='+item.id)">
					  			<img :style='{"padding":"5px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","borderColor":"#ccc","backgroundColor":"rgba(255, 192, 1, 1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' style="object-fit: cover;width: 100%;height: 100%;box-sizing: border-box;" :src="baseurl+item.picture">
					  		</div>
					  	</div>
					  </div>
					  <div class="new6-list" style="width: 40%;" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(255, 192, 1, 1)","overflow":"hidden","borderRadius":"0","borderWidth":"0","width":"40%","boxSizing":"border-box","borderStyle":"solid","height":"250px"}'>
					    <div class="news-title-box" style="display: flex;justify-content: space-between;align-items: center;">
					      <div class="new-title" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(43,135,33,0)","color":"#fff","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"28px","fontSize":"14px","borderStyle":"solid"}'>最新动态</div>
					      <button @click="jump('../news/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 15px","boxShadow":"none","margin":"4px auto","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(255, 192, 1, 1)","borderRadius":"6px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"34px"}'>查看更多<i v-if="true" :style='{"isshow":true,"padding":"0 0 0 1px","fontSize":"14px","color":"rgba(255, 192, 1, 1)"}' class="layui-icon layui-icon-next"></i></el-button>
					    </div>
					    <div v-for="(item,index) in newsList" v-if="index<5" :key="index" @click="jump('../news/detail.jsp?id='+item.id)" class="new6-list-item" style="display: flex;box-sizing: border-box;" style="box-sizing: border-box;" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 0 5px 0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"100%","borderStyle":"solid","height":"auto"}'>
