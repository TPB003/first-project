		...
		<div id="app">
			<div class="data-detail" style="padding:0;">
				<div class="data-detail-breadcrumb" :style='{"padding":"0 10px","boxShadow":"0 0 6px #FFC001","margin":"20px auto","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","height":"54px"}'>
					...
					<a v-if='storeupFlag' :style='{"padding":"0 12px","boxShadow":"none","borderColor":"rgba(255, 192, 1, 1)","backgroundColor":"#fff","color":"rgba(255, 0, 0, 1)","borderRadius":"4px","borderWidth":"1px","fontSize":"16px","lineHeight":"34px","borderStyle":"solid"}' @click="storeUp()" href="javascript:void(0)">
						<i class="layui-icon" style="font-size: 20px;color: red;" v-if='true' :style='{"color":"rgba(255, 192, 1, 1)","padding":"0 2px 0 0","fontSize":"18px"}'>&#xe67a;</i>取消收藏
					</a>
					<a v-if='!storeupFlag' :style='{"padding":"0 12px","boxShadow":"none","borderColor":"rgba(255, 192, 1, 1)","backgroundColor":"#fff","color":"rgba(255, 0, 0, 1)","borderRadius":"4px","borderWidth":"1px","fontSize":"16px","lineHeight":"34px","borderStyle":"solid"}' @click="storeUp()" href="javascript:void(0)">
						<i class="layui-icon" style="font-size: 20px;color: red;" v-if='true' :style='{"color":"rgba(255, 192, 1, 1)","padding":"0 2px 0 0","fontSize":"18px"}'>&#xe67b;</i>点我收藏
					</a>
			...
			<div class="data-detail" style="padding:0;width:100%;" :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"rgba(255, 255, 255, 0.3)","borderStyle":"solid"}'>
				<div class="layui-row" style="display: flex;width:980px;margin: 0 auto;">
					...
					<div class="layui-col-md7" style="padding-left: 20px;flex: 1;" :style='{"padding":"0","boxShadow":"none","margin":"0 0 0 20px","borderColor":"rgba(255, 192, 1, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px","borderStyle":"solid"}'>
						...
						<div :style='{"padding":"6px 15px","boxShadow":"none","margin":"0","borderColor":"rgba(0, 0, 0, 0.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"18px","color":"#333","textAlign":"right"}'>车位状态：</span>
							<span :style='{"padding":"5px 15px","boxShadow":"none","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","color":"rgba(255, 192, 1, 1)","borderRadius":"4px","textAlign":"center","borderWidth":"0","width":"auto","lineHeight":"34px","fontSize":"18px","borderStyle":"solid"}' class="desc">
								{{detail.cheweizhuangtai}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"none","margin":"0","borderColor":"rgba(0, 0, 0, 0.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"18px","color":"#333","textAlign":"right"}'>租赁价格：</span>
							<span :style='{"padding":"5px 15px","boxShadow":"none","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","color":"rgba(255, 192, 1, 1)","borderRadius":"4px","textAlign":"center","borderWidth":"0","width":"auto","lineHeight":"34px","fontSize":"18px","borderStyle":"solid"}' class="desc">
								{{detail.zulinjiage}}
							</span>
						</div>
						...
						<div class="detail-item" :style='{"padding":"6px 15px","boxShadow":"none","margin":"0","borderColor":"rgba(0, 0, 0, 0.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' style="text-align: right;">
							...
							<button :style='{"padding":"0 10px","boxShadow":"none","margin":"0 5px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"4px","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' v-if="isAuth('cheweixinxi','租赁')" @click="onAcrossTap('cheweizulin','cheweizhuangtai','已租出','已租,未租'.split(',')[0])" type="button" class="layui-btn">
								租赁
							</button>
		...
		<script>
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
								userid: localStorage.getItem('userid'),
								name: this.title,
								picture:vue.detail.cheweitupian,
								refid: this.detail.id,
								tablename: this.detailTable
							}, function(res) {
								layer.msg('收藏成功', {
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
					vue.title = vue.detail.cheweimingcheng;
					// 轮播图片
					vue.swiperList = vue.detail.cheweitupian ? [http.baseurl+vue.detail.cheweitupian.split(",")[0]] : [];
					// var swiperItemHtml = '';
