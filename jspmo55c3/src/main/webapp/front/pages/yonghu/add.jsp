			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.cheliangpinpai" type="text" :readonly="ro.cheliangpinpai" name="cheliangpinpai" id="cheliangpinpai" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		                <label class="layui-form-label">车位名称</label>
		                <div class="layui-input-block">
		                    <select name="cheweimingcheng" id="cheweimingcheng" lay-filter="cheweimingcheng" disabled >
		                        <option value="">请选择</option>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.shoujihao" type="text" :readonly="ro.shoujihao" name="shoujihao" id="shoujihao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
