...
<html>
	...
	<body>
			...
			<form class="layui-form login-form" :style='{"padding":"20px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.5)","borderRadius":"20px","borderWidth":"0","width":"400px","borderStyle":"solid","justifyContent":"center","height":"auto"}'>
				...
				<div class="title" v-if="true" :style='{"padding":"0","boxShadow":"none","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(255, 192, 1, 1)","isshow":true,"borderRadius":"100%","borderWidth":"0","width":"auto","lineHeight":"38px","fontSize":"20px","borderStyle":"solid"}'>车位报修注册</p></div>
