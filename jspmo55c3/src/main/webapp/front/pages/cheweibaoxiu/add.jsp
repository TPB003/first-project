			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="baoxiuneirong" id="baoxiuneirong">请输入报修内容</textarea>
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                var edit = tinymce.render({
                    ...
                    images_upload_handler: function(blobInfo, succFun, failFun) {
                        ...
                        xhr.send(formData);
                                ...
                                jquery('#baoxiushijian').val(getCurDateTime());
				laydate.render({
					elem: '#baoxiushijian',
					type: 'datetime'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='baoxiushijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.baoxiushijian = true;
                                                jquery('#baoxiushijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='zhanghao'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					var baoxiuneirong = tinymce.get('#baoxiuneirong').getContent()
					data.baoxiuneirong = baoxiuneirong;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('cheweibaoxiu/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('cheweibaoxiu' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
