...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">续费提醒管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>续费提醒列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">续费提醒列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xufeijine')">续费金额<i id="xufeijineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('beizhu')">备注<i id="beizhuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tixingshijian')">提醒时间<i id="tixingshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xufeijineCell  = document.createElement('td');

						 xufeijineCell.innerHTML = item.xufeijine;

			row.appendChild(xufeijineCell);
			var beizhuCell  = document.createElement('td');

						 beizhuCell.innerHTML = item.beizhu;

			row.appendChild(beizhuCell);
			var tixingshijianCell  = document.createElement('td');

						  tixingshijianCell.innerHTML = item.tixingshijian;


			row.appendChild(tixingshijianCell);
		...
		function sh(){
			...
			httpJson("xufeitixing/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xufeitixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xufeitixing");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"xufeitixing");
