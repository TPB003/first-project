...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shoujihao')">手机号<i id="shoujihaoIcon" class="fa fa-sort"></i></th>
											<th>头像</th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shoujihaoCell  = document.createElement('td');

						 shoujihaoCell.innerHTML = item.shoujihao;

			row.appendChild(shoujihaoCell);
