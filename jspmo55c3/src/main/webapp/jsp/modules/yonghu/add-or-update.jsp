...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>车辆品牌</label>
										<input name="cheliangpinpai" id="cheliangpinpai" name="cheliangpinpai" class="form-control" placeholder="车辆品牌">
									</div>
									<div class="form-group col-md-6">
										<label>车位名称</label>
										<select id="cheweimingchengSelect" name="cheweimingcheng" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>手机号</label>
										<input name="shoujihao" id="shoujihao" name="shoujihao" class="form-control" placeholder="手机号">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
	...
	<script>
		...
		var cheweimingchengOptions = [];

		function cheweimingchengSelect(){
			http("option/cheweixinxi/cheweimingcheng","GET",{},(res)=>{
				if(res.code == 0){
					cheweimingchengOptions = res.data;
					var nullOption = document.createElement('option');
					var cheweimingchengSelect = document.getElementById('cheweimingchengSelect');
					cheweimingchengSelect.appendChild(nullOption);
					for(var i=0;i<cheweimingchengOptions.length;i++){
						var cheweimingchengOption = document.createElement('option');
						cheweimingchengOption.setAttribute('name','cheweimingchengOption');
						cheweimingchengOption.setAttribute('value',cheweimingchengOptions[i]);
						cheweimingchengOption.innerHTML = cheweimingchengOptions[i];									
						if(ruleForm.cheweimingcheng == cheweimingchengOptions[i]){
							cheweimingchengOption.setAttribute('selected','selected');
						}
						cheweimingchengSelect.appendChild(cheweimingchengOption);
					}
				}
			});
		}	
		...
		function submit() {
                //获取表单数据前取消禁用
                $("#cheweimingchengSelect").attr('disabled',false);
		...
		function dataBind(){
			...
			var cheweimingchengOptions = document.getElementsByClassName("cheweimingchengOption");
			for(var cheweimingchengCount = 0; cheweimingchengCount < cheweimingchengOptions.length;cheweimingchengCount++){
				if(cheweimingchengOptions[cheweimingchengCount].getAttribute('value') == ruleForm.cheweimingcheng){
					cheweimingchengOptions[cheweimingchengCount].setAttribute('selected','selected');
				}
			}
			$("#shoujihao").val(ruleForm.shoujihao);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.cheweimingcheng != null && res.data.cheweimingcheng != ''){
						...
						var cheweimingchengOptions = document.getElementsByClassName("cheweimingchengOption");
						for(var cheweimingchengCount = 0; cheweimingchengCount < cheweimingchengOptions.length;cheweimingchengCount++){
							if(cheweimingchengOptions[cheweimingchengCount].getAttribute('value') == res.data.cheweimingcheng){
								cheweimingchengOptions[cheweimingchengCount].setAttribute('selected','selected');
							}
						}
					}
					if(res.data != null && res.data != '' && res.data.shoujihao != null && res.data.shoujihao != ''){

						$("#shoujihao").val(res.data.shoujihao);
						$("#shoujihao").attr('readonly','readonly');
					}
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#cheweimingchengSelect").attr('disabled',true);
            }
		}
