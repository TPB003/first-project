...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210309/b66960b8e794497e8e47006ce61e707d.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="xiaoqumingcheng" placeholder="小区名称" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">楼栋单元</label> 
							<input type="text" name="loudongdanyuan" placeholder="楼栋单元" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">车辆品牌</label> 
							<input type="text" name="cheliangpinpai" placeholder="车辆品牌" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">手机号</label> 
							<input type="text" name="shoujihao" placeholder="手机号" class="form-control-i">
							</div>
